 ...
 */
public abstract class Hilt_FavoritesMatchesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavoritesMatchesFragment() {
    super();
  }

  Hilt_FavoritesMatchesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoritesMatchesFragment_GeneratedInjector) this.generatedComponent()).injectFavoritesMatchesFragment(UnsafeCasts.<FavoritesMatchesFragment>unsafeCast(this));
    }
  }
